...
function(t, e, o) {
	...
	L.StyleEditor.Util = L.Class.extend({
		...
		getMarkersForColor: function(t) {
			...
			if (Array.isArray(e) || (e = Object.keys(e).includes(t) ? e[t] : e.
		default), null !== o) {
				if (!Array.isArray(o)) {
					var i = Object.keys(o);
					o = i.includes(t) ? o[t] : i.includes("default") ? o.
				default:
					e
				}
	...
	L.StyleEditor.formElements.FormElement = L.Class.extend({
		...
		setStyle: function(t) {
			...
			for (var i = 0; i < o.length; i++) {
				var n = o[i];
				if (n instanceof L.Marker) this.options.styleEditorOptions.markerType.setStyle(this.options.styleOption, t);
				else {
					var s = {};
		...
		_setStyle: function() {
			...
			for (var i = 0; i < o.length; i++) {
				...
				if (n && n.getPopup && n.bindPopup) {
					var s = n.getPopup();
					s ? s.setContent(e) : n.bindPopup(e),
					n.options = n.options || {},
					n.options.popupContent = e
				}
			}
			this.setStyle(e)
		}
	...
	L.StyleEditor.marker.DefaultMarker = L.StyleEditor.marker.Marker.extend({
		...
		_getMarkerUrl: function(t, e, o) {
			...
			return o && (i += "-" + o),
			i + "+" + (e = 0 === e.indexOf("#") ? e.replace("#", "") : this.options.styleEditorOptions.util.rgbToHex(e, !0)) + ".png"
		},
		options: {
	...
	L.StyleEditor.marker.GlyphiconMarker = L.StyleEditor.marker.Marker.extend({
		...
		options: {
			markers: ["glyphicon-plus", "glyphicon-asterisk", "glyphicon-plus", "glyphicon-euro"]
		}
	}),
	...
	L.Control.StyleEditor = L.Control.extend({
		...
		createUi: function() {
			var t = this.options.controlDiv = L.DomUtil.create("div", "leaflet-control-styleeditor leaflet-control leaflet-bar"); (this.options.controlUI = L.DomUtil.create("a", "leaflet-control-styleeditor-interior", t)).title = "样式编辑";
		...
		enable: function(t) {
			this._layerIsIgnored(t) || (L.DomUtil.addClass(this.options.controlUI, "enabled"), this.options.map.eachLayer(this.addEditClickEvents, this), this.showCancelButton(), this.createTooltip(), void 0 !== t && (this.isEnabled() && this.removeIndicators(), this.initChangeStyle({
				target: t
			})))
		},
		isEnabled: function() {
		...
		addEditClickEvents: function(t) {
			if (!this._layerIsIgnored(t)) if (this.options.useGrouping && t instanceof L.LayerGroup) this.options._layerGroups.push(t);
		...
		getMatchingElement: function(t) {
			for (var e = null,
			o = t.target,
			i = 0; i < this.options._layerGroups.length; ++i) if ((e = this.options._layerGroups[i]) && o !== e && e.hasLayer(o)) return e.options && e.options.opacity || (e.options = o.options, o.setIcon && (e.setIcon = function(t) {
