...
, function(t, n, i) {
    ...
    e.prototype = {
        ...
        _build: function(t, n, i, a) {
            ...
            if (r <= s)
                return o(e = _(t.slice(n, i + 1)), this.toBBox),
                e;
            ...
            for (p(t, n, i, f, this.compareMinX),
            h = n; h <= i; h += f)
                for (p(t, h, c = Math.min(h + f - 1, i), u, this.compareMinY),
                l = h; l <= c; l += u)
                    m = Math.min(l + u - 1, c),
                    e.children.push(this._build(t, l, m, a - 1));
            return o(e, this.toBBox),
            e
        },
        _chooseSubtree: function(t, n, i, a) {
            for (var e, r, o, s, h, l, c, u, f, d; a.push(n),
            !n.leaf && a.length - 1 !== i; ) {
                for (c = u = 1 / 0,
                e = 0,
                r = n.children.length; e < r; e++)
                    ...
                    f = t,
                    d = o,
                    (l = (Math.max(d.maxX, f.maxX) - Math.min(d.minX, f.minX)) * (Math.max(d.maxY, f.maxY) - Math.min(d.minY, f.minY)) - h) < u ? (u = l,
                    c = h < c ? h : c,
                    s = o) : l === u && h < c && (c = h,
                    s = o);
                n = s || n.children[0]
    ...
    t.exports = function(t) {
        var n = (t.Layer ? t.Layer : t.Class).extend({
            ...
            _reset: function() {
                ...
                // this._canvas.style.width = i.x,
                // this._canvas.style.height = i.y,
                // this._canvas.style.width = i.x + 'px';
                // this._canvas.style.height = i.y + 'px';
                this._redraw()
            },
            _redraw: function(t) {
                var n = this;
            ...
            _initCanvas: function() {
                ...
                this._canvas.width = 2*n.x;
                this._canvas.height = 2*n.y;
