...
, function(e, t, r) {
    e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Measure distances and areas">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>测量距离和面积</h3> <ul class=tasks> <a href=# class="js-start start">创建新测量</a> </ul> </div> <div class=js-measuringprompt> <h3>测量距离和面积</h3> <p class=js-starthelp>添加点开始测量</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">取消</a></li> <li><a href=# class="js-finish finish">完成</a></li> </ul> </div> </div> '
}
, function(e, t, r) {
    e.exports = ' <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>路径长度：</span> {{ (model.length/1000).toFixed(3) }} km</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>面积：</span> {{ (model.area/10000).toFixed(4) }} 公顷</p> </div> <% } %> '
}
, function(e, t, r) {
