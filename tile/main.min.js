...
var app = (function (exports) {
  ...
  function initTileCoords(params) {
    ...
    function updateTransform(zNew, x0new, y0new) {
      ...
      params.zoom = zoom
      params.xTile0 = xTile0
      params.yTile0 = yTile0
      params.xTile1 = xTile0 + params.width / 256
      params.yTile1 = yTile0 + params.height / 256
  ...
  function initControls(map, boxQC) {
    ...
    document.getElementById("vectorCanvas").addEventListener("dblclick", function (c) {
      let x1 = c.layerX
      let y1 = c.layerY
      // console.log(x1, y1)
      console.log(pix2coord(x1, y1))
      var topLeft = [pix2coord(x1, y1)[0] / degrees, pix2coord(x1, y1)[1] / degrees];
      var p1 = [];
      lonLatToXY(p1, topLeft);
      if (params.zoom < params.maxZoom) {
        params.zoom = params.zoom + 1
        params.center = p1
        map.setCenterZoom(p1, params.zoom);
        console.log("当前缩放级别", params.zoom)
      }
      // move(1, 0, 0);
